...
import com.terry.springbootmall.rowmapper.OrderItemRowMapper;
import com.terry.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<OrderItem> getOrderItemsByOrderId(Integer orderId) {
        ...
        String sql = "SELECT oi.order_item_id, oi.order_id, oi.product_id, oi.quantity, oi.amount," +
                ...
                " WHERE oi.order_id = :orderId";  //配合前端消費者需求
